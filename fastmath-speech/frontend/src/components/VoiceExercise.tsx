...
import { QuestionVoiceInput } from './VoiceInput';
...
export const VoiceExercise: React.FC = () => {
  ...
  const handleAnswer = async (answer: number, typingData?: { count: number; time: number; inputMethod: 'voice' | 'keyboard' }) => {
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 text-center text-gray-600">
          ...
          <p className="text-sm mt-2">Voice recognition is continuously listening</p>
        </div>
      </div>
    </div>
  );
