...
import { TripleVoiceInputDirect, TranscriptionData } from './TripleVoiceInputDirect';
...
export const VoiceExerciseWithDirect: React.FC = () => {
  ...
  const handleServicesReady = (webSpeechReady: boolean, deepgramReady: boolean, groqReady: boolean) => {
    // For direct approach, we consider services ready when at least one is ready
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex justify-between mb-2">
            ...
            <span className="text-sm text-gray-600">
              Triple Voice Input Test (Direct Audio Streaming)
            </span>
          </div>
        ...
        <div className="mt-8 text-center text-gray-600">
          ...
          <p className="text-sm mt-2">Web Speech API, Deepgram, and Groq/Whisper are listening</p>
        </div>
      </div>
    </div>
  );
